...
const color GREY = color(106, 106, 106);
...
const color BLUE1 = color(2, 113, 156);
const color DODGERBLUE = color(30, 144, 255);
const color LIGHTBLUE1 = color(27, 144, 193);
const color DEEPSKYBLUE = color(1, 181, 255);
...
const color GREEN1 = color(1, 154, 30);
const color CHARTREUSE = color(127, 255, 0);
const color MEDIUMSPRINGGREEN = color(0, 241, 165);
...
const color YELLOW = color(255, 235, 0);
const color GOLD = color(206, 188, 0);
...
const color ROSYBROWN = color(160, 134, 109);
...
const color ORANGE = color(255, 188, 1);
const color DARKORANGE = color(196, 143, 1);
...
const color RED = color(254, 0, 0);
const color RED1 = color(171, 6, 4);
...
const color MAGENTA = color(255, 2, 217);
const color VIOLET = color(186, 1, 255);
const color VIOLET1 = color(111, 8, 151);
...
const color PURPLE = color(106, 1, 254);
const color PURPLE1 = color(74, 9, 161);
...
const color DARKMAGENTA = color(148, 9, 126);
const color DARKRED = color(139, 0, 0);
const color LIGHTGREEN = color(144, 238, 144);
const color BINKBODY = color(242, 211, 182);
const color WHITEGRAY = color(201, 201, 201);
